  ...
  navbarPage(
    ...
    tabPanel(
      ...
      HTML(
        ...
        <li> Each observation of X is independent and approximately normally distributed </li>
      ...
      sidebarLayout(
        sidebarPanel(
          ...
          numericInput('mu', HTML("Specify the mean, &#956&#8320"), 7),

          helpText("Hypotheses"),
          tags$b("Null hypothesis"),
          HTML(
            "<p> &#956 = &#956&#8320: the population mean of X is &#956&#8320 </p>"
          ),
          radioButtons(
            "alt.pt",
          ...
          sliderInput(
            "bin",
            "The width of bins in histogram",
            min = 0.01,
            max = 5,
            value = 0.2
          )
    ...
    tabPanel(
      ...
      tags$ul(
        tags$li(
          "Each of the two populations being compared should follow the normal distribution"
        ),
        tags$li(
          "X and Y should be sampled independently from the two populations being compared"
        ),
        tags$li(
      ...
      sidebarLayout(
        sidebarPanel(
          ...
          tags$b("Null hypothesis"),
          HTML(
            "<p> &#956&#8321 = &#956&#8322: X and Y have equal population mean </p>"
          ),
          radioButtons(
            "alt.t2",
            label = "Alternative hypothesis",
            choiceNames = list(
              HTML(
                "&#956&#8321 &#8800 &#956&#8322: the population means of X and Y are not equal"
              ),
              HTML(
                "&#956&#8321 < &#956&#8322: the population means of X is less than Y"
              ),
              HTML(
                "&#956&#8321 > &#956&#8322: the population means of X is greater than Y"
              )
            ),
            choiceValues = list("two.sided", "less", "greater")
          ),
    ...
    tabPanel(
      ...
      tags$ul(
        ...
        tags$li(
          "The differences of paired samples are numeric and continuous and based on the normal distribution"
        ),
      ...
      sidebarLayout(
        ...
        mainPanel(
          ...
          splitLayout(
            ...
            wellPanel(verbatimTextOutput("info.p"), hr(),
                      helpText(
                        HTML(
                          "Notes:
                          <ul>
