 ...
 # 1.2. Wilcoxon Signed-Rank Test
  sidebarLayout(
    sidebarPanel(
      ...
      radioButtons("nap.wsr", label = "Normal Approximation",
        choices = list(
          "Sample size is not large" = FALSE,
  ...
  #p("To determine whether a randomly selected sample will be less than or greater than a second randomly selected sample."),
    ...
    sidebarLayout(
      ...
      p(tags$b("No outliers"), 
        "To determine if the distributions of the two groups are similar in shape and spread"),
      p(tags$b("Outliers exist"), 
        "To determine if the distributions of the two groups are different in shape and spread"),
