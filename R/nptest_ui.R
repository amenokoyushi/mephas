...
numericInput("med", HTML("The specific value, m&#8320"), 4),
...
choiceValues = list("two.sided", "less", "greater"))),
  ...
  mainPanel(h3(tags$b('Results')),
    ...
    #tags$b("Interpretation"), p("TBC"))  ),

sidebarLayout(
  sidebarPanel(

h4(tags$b("Wilcoxon Signed-Rank Test")),
helpText("Alternative to one-sample t-test when the data cannot be assumed to be normally distributed. It’s used to determine whether the median of the sample is equal to a specified value."),
...
helpText("Normal approximation is applicable when sample size > 10.")),
  ...
  mainPanel(h3(tags$b('Results')),
    ...
    tags$b("Interpretation:"), p("Lorem ipsum dolor sit amet."))  ),
...
hr(),
h4("Data Display"), helpText("Change the names of two samples (optinal)"), tags$textarea(id="cn", rows=2, "X"), dataTableOutput("table"),
...
mainPanel(h3(tags$b("Results")), tableOutput("mood.test"), p(br()), tags$b("Interpretation:"), p(" Lorem ipsum dolor sit amet.")) ),
...
hr(),
h4("Data Display"), helpText("Change the names of two samples (optinal)"), tags$textarea(id="cn2", rows=2, "X\nY"), dataTableOutput("table2"),
...
hr(),
h4("Data Display"), helpText("Change the names of two samples (optional)"), tags$textarea(id="cn3", rows=2, "X\nY\n(X-Y)"), dataTableOutput("table3"),
