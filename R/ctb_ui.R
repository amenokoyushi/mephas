    ...
    tabPanel("Chi-square Test (R x C Table)",
      ...
      sidebarLayout(
        ...
        mainPanel(
          ...
          hr(),
          h4("Display of the Contingency table"), 
          dataTableOutput("ct"),
          hr(),
          h3(tags$b("Results of the Chi-Square Test")), 
          tableOutput("c.test"),
          ...
          h4("Percentages for rows"), 
          tableOutput("prt"),
          h4("Percentages for columns"), 
          tableOutput("pct"),
          h4("Percentages for total"),  
          tableOutput("pt"),
          hr(),
          h3(tags$b('Barplot of frequency (counts)')), 
    ...
    tabPanel("Test for Trend (2 x K Table)",
      ...
      sidebarLayout(
        ...
        mainPanel(
          ...
          hr(),
          h3(tags$b("Results of the Test for Trend, Case out of Total")), 
          tableOutput("tr.test"),
          #tags$b("Interpretation"), 
          #p("The meaning"),
          hr(),
          h3(tags$b('Barplot of Case Percentage')), 
          plotOutput("makeplot.tr", width = "600px", height = "300px")
          )
        )
      ),
    ...
    tabPanel("Kappa Statistic (K x K Table)",
      ...
      sidebarLayout(
        ...
        mainPanel(
          ...
          hr(),
          h3(tags$b("Results of the Kappa Statistic, k")), 
          tableOutput("k.test"),
          tags$b("Guidelines"),
          HTML("
            <ul>
